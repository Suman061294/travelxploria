...
const Enquery: React.FC<Props> = ({ props }) => {
    return (
        <>
            <div className="container-full">
                <div className={`newsletter-block md:py-10 sm:py-5 py-0 sm:px-8 px-0 sm:rounded-[15px] rounded-xl flex flex-col items-start ${props}`}>
                        ...
                        <form className="w-full flex flex-col sm:flex-row sm:flex-wrap sm:gap-4 gap-3" action="post">
                            ...
                            <div className="flex-1 sm:w-auto w-full">
                                <input
                                    ...
                                    className="caption1 w-full h-[48px] pl-2 pr-2 rounded-[10px] border border-line"
                                    required
                                />
                            </div>
